...
> Vous pouvez retourner au point de départ en appuyant sur A et B en même temps pendant que l'écran est en train de fondre vers le blanc lors de la transition vers un menu (par exemple, après avoir appuyé sur START ou SELECT)
> 
> (Si la téléportation ne marche pas, vérifiez si les contrôles sont correctement assignés)
